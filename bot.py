...
async def manual_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if 'manual_step' in context.user_data:
        ...
        if step == 1:
            ...
            await update.message.reply_text("✍️😂  أرسل عدد المشاهدات  
            ...
            try:
                ...
                await update.message.reply_text("💔❌ خطأ: ارسل عدد المشاهدات.")
...
app.add_handler(CommandHandler("manual", manual_input))
